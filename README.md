...
* **This modified version is for machines without cuda!**
* The `setup.py` does not build `connected_compoents.cu`.
* Only `video_predictor` works and it does not use `fill_holes_in_mask_scores`.
